...
output_filename=raw_input("输入报告名称(可指定磁盘，例如“d:主机报告”):".decode('utf8').encode('mbcs'))
fp=open(output_filename+".html","w")
...
for sys in c.Win32_OperatingSystem():
    ...
    <td>''' + sys.Caption.encode("UTF8") + '''</td>
    <td>''' + sys.OSArchitecture.encode("UTF8") + html_tr_right_str
